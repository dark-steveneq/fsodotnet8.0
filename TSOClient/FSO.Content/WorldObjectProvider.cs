...
namespace FSO.Content
{
    ...
    public class WorldObjectProvider : AbstractObjectProvider
    {
        ...
        public void Init(bool withSprites)
        {
            ...
            string[] paths = Directory.GetFiles(Path.Combine(Path.GetDirectoryName(Process.GetCurrentProcess().MainModule.FileName), FSOEnvironment.ContentDir, "Objects"), "*.iff", SearchOption.AllDirectories);
